                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="number" id="rating" name="rating" class="form-control" placeholder="Ratings">
                            </div>
                ...
                <form id="updateForm" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="number" id="up_rating" name="rating" class="form-control" placeholder="Ratings">
                        </div>
