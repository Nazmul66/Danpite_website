    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
                ...
                <div class="row">
                    <div class="col mb-3">
                        <label for="safty_content1" class="form-label">Safty Content 1</label>
                    ...
                    <div class="col mb-3">
                        <label for="safty_img1" class="form-label">Safty Content Image 1</label>
                ...
                <div class="row">
                    <div class="col mb-3">
                        <label for="safty_content2" class="form-label">Safty Content 2</label>
                    ...
                    <div class="col mb-3">
                        <label for="safty_img2" class="form-label">Safty Content Image 2</label>
                ...
                <div class="row">
                    <div class="col mb-3">
                        <label for="safty_content3" class="form-label">Safty Content 3</label>
                    ...
                    <div class="col mb-3">
                        <label for="safty_img3" class="form-label">Safty Content Image 3</label>
                ...
                <div class="row">
                    <div class="col mb-3">
                        <label for="safty_content4" class="form-label">Safty Content 4</label>
                    ...
                    <div class="col mb-3">
                        <label for="safty_img4" class="form-label">Safty Content Image 4</label>
